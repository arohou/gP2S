...
@Table(name="blotting_paper")
@Entity
public class BlottingPaper extends BaseSlugAndLabelEntity {
	...
	@Builder
	public BlottingPaper(Long id, String label, String slug, Integer version,
                         Date createdDate, Date modifiedDate, String createdBy,
                         String modifiedBy, String manufacturer, String model) {
