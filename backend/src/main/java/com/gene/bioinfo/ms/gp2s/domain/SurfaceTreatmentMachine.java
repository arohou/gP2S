...
@Table(name="surface_treatment_machine")
@Entity
public class SurfaceTreatmentMachine extends BaseSlugAndLabelEntity {
	...
	@Builder
	public SurfaceTreatmentMachine(Long id, String label, String slug, Integer version,
