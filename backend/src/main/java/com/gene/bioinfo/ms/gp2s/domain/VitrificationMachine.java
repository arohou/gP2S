...
@Table(name = "vitrification_machine")
@Entity
public class VitrificationMachine extends BaseSlugAndLabelEntity {
    ...
    @Builder
    public VitrificationMachine(Long id, String label, String slug, Integer version,
