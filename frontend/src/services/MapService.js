...
const URI = 'map/'
const URI_MAP_LINK = 'map-link/'

export default class MapService extends AttachmentService {
  ...
  saveMapLinks (slugOrId, entity) {
    const body = JSON.stringify(entity)
    return HTTP.post(URI_MAP_LINK + slugOrId, body)
  }

  getMapLinks (slugOrId) {
    return HTTP.get(URI_MAP_LINK + slugOrId)
  }
}
