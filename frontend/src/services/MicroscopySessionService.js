...
/**
 * @author Cezary Krzyżanowski on 10.11.2017.
 */

import { HTTP } from '@/utils/http-common'

const URI = 'microscopy-session/'
...
export default class GridService {
  ...
  getEntityProjectsBySlugOrId (slugOrId) {
  ...
  getDefaultValues (projectSlugOrId) {
    return HTTP.get('default-value/microscopy_session/' + projectSlugOrId)
  }
