...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Create sample'" @actionConfirm="submitBaseFormBy('sample')"></actions-header>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loadFormData () {
        this.sample.label = this.defaultNewLabel('Sample')
        this.sample.availableForGridMaking = true
      }
    }
  }
</script>
