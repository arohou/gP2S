...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Editing processing session'"
...
<script>
  ...
  export default {
    ...
    methods: {
      saveForm () {
        return this._service.saveEntity(this.projectId, this.entity)
