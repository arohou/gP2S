...
<template>
  <div class="blotting-paper-base-form base-form">
    <el-form class="em-main-form" ref="mainForm" :model="entity" :rules="rules" labelPosition="top">
      <div class="base-form__metadata">
        <el-row>
          <el-col>
            <el-form-item label="Blotting Paper label" prop="label" :error="getError('label')">
      ...
      return {
        rules: {
          label: [
            {
              required: true,
              message: 'Blotting paper label can\'t be empty',
              trigger: 'blur'
            }
          ],
          manufacturer: [{
