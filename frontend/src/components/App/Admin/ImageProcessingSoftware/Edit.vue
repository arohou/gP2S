...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Editing Image Processing Software'"
...
<script>
  ...
  export default {
    ...
    methods: {
      saveForm () {
        return this._imageProcessingSoftwareService.saveEntity(this.entity)
          .then(result => {
