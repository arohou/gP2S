...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Copying Surface Treatment Machine'" @actionConfirm="submitBaseFormBy('mainForm')"></actions-header>
...
<script>
  ...
  export default {
    name: 'surface-treatment-machine-copy',
