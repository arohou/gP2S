...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Editing Surface Treatment Machine'" @actionConfirm="submitBaseFormBy('mainForm')"></actions-header>
...
<script>
  ...
  export default {
    name: 'surface-treatment-machine-edit',
