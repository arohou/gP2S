...
<template>
  <div class="surface-treatment-machine-base-form base-form">
    <el-form class="em-main-form" ref="mainForm" :model="entity" :rules="rules" labelPosition="top">
      <div class="base-form__metadata">
        <el-row>
          <el-col>
            <el-form-item label="Surface Treatment Machine label" prop="label" :error="getError('label')">
...
<script>
  ...
  export default {
    name: 'surface-treatment-machine-base-form',
      ...
      return {
        rules: {
          label: [
            {
              required: true,
              message: 'Surface Treatment Machine label can\'t be empty',
              trigger: 'blur'
            }
          ],
          manufacturer: [{
