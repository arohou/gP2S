...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Creating Grid Type'" @actionConfirm="submitBaseFormBy('mainForm')" @actionCancel="cancel('mainForm')"></actions-header>
  ...
  export default {
    ...
    methods: {
      ...
      loadFormData () {
        this.entity = {
          id: '',
          label: this.defaultNewLabel('Grid type'),
          manufacturer: '',
          description: ''
        }
      }
