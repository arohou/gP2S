...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Creating electron detector'" @actionConfirm="submitBaseFormBy('mainForm')"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loadFormData () {
        this.entity.label = this.defaultNewLabel('Electron detector')
      }
    }
  }
</script>
