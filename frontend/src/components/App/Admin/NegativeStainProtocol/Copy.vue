...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Copying Negative Stain Protocol'" @actionConfirm="submitBaseFormBy('mainForm')"></actions-header>
...
<script>
  ...
  export default {
    name: 'negative-stain-protocol-copy',
        ...
        return service.getEntityBySlugOrId(slugOrId)
               .then(result => {
                 this.entity = {
                   ...
                   incubationTime: result.data.incubationTime,
