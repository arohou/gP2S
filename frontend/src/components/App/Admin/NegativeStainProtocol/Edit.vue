...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Editing Negative Stain Protocol'" @actionConfirm="submitBaseFormBy('mainForm')"></actions-header>
...
<script>
  ...
  export default {
    name: 'negative-stain-protocol-edit',
