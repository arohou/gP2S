...
<template>
  <div class="storage-device-base-form base-form">
    <el-form class="em-main-form" ref="mainForm" :model="entity" :rules="rules" labelPosition="top">
      <div class="base-form__metadata">
        <el-row>
          <el-col>
            <el-form-item label="Storage Device label" prop="label" :error="getError('label')">
        ...
        <el-row :gutter="24">
          <el-col :sm="8">
            <el-form-item label="Has cylinders?" prop="hasCylinders" :error="getError('hasCylinders')">
              <el-radio-group v-model="entity.hasCylinders">
          ...
          <el-col :sm="8">
            <el-form-item label="Has tubes?" prop="hasTubes" :error="getError('hasTubes')">
              <el-radio-group v-model="entity.hasTubes">
                <el-radio-button :label="true">Yes</el-radio-button>
                <el-radio-button :label="false">No</el-radio-button>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :sm="8">
            <el-form-item label="Has boxes?" prop="hasBoxes" :error="getError('hasBoxes')">
              <el-radio-group v-model="entity.hasBoxes">
                <el-radio-button :label="true">Yes</el-radio-button>
                <el-radio-button :label="false">No</el-radio-button>
              </el-radio-group>
            </el-form-item>
...
<script>
  ...
  export default {
    name: 'cryo-storage-device-base-form',
      ...
      return {
        rules: {
          label: [
            {
              required: true,
              message: 'Cryo storage device label can\'t be empty',
              trigger: 'blur'
            }
          ],
          manufacturer: [{
