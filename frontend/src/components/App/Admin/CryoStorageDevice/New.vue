...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Creating Storage Device'" @actionConfirm="submitBaseFormBy('mainForm')"
  ...
  export default {
    ...
    methods: {
      ...
      loadFormData () {
        this.entity = {
          id: '',
          label: this.defaultNewLabel('Cryo storage device'),
          manufacturer: '',
          model: '',
          location: '',
          hasCylinders: true,
