...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Editing Vitrification Machine'" @actionConfirm="submitBaseFormBy('mainForm')"></actions-header>
...
<script>
  ...
  export default {
    name: 'vitrification-machine-edit',
