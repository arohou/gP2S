...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Editing Vitrification Protocol'" @actionConfirm="submitBaseFormBy('mainForm')"></actions-header>
...
<script>
  ...
  export default {
    name: 'vitrification-protocol-edit',
