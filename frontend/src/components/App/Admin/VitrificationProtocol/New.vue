...
<template>
  <form-component>
    <actions-header slot="action-header" :title="'Creating Vitrification Protocol'" @actionConfirm="submitBaseFormBy('mainForm')" @actionCancel="cancel('mainForm')"></actions-header>
...
<script>
  ...
  export default {
    name: 'vitrification-protocol-new',
    ...
    methods: {
      ...
      loadFormData () {
        this.entity = {
          id: '',
          label: this.defaultNewLabel('Vitrification protocol'),
          relativeHumidity: '',
          temperature: '',
          blotTime: '',
          waitTime: '',
